...
flowchart LR
    ...
    WCAM -. "sees rabbit_sign" .-> RSIGN
    RCAM -. "sees wolf_sign" .-> WSIGN
...
|:-----------:|:-------------------------:|:-------------------:|:---------------------------:|
|    Aldrick  | robot behavior & geofence |[`8df8946`](https://github.com/abc-mobile-robotics/abc-mobile-robotics.github.io/commit/8df8946)| wolf_fsm.py, rabbit_fsm.py, geofence_node.py |
|    Brian    | vision system             |[`d996d1b`](https://github.com/abc-mobile-robotics/abc-mobile-robotics.github.io/commit/d996d1b)| yolo_detector.py                             |
|    Chach    | hardware connections      |[`eab7cd7`](https://github.com/abc-mobile-robotics/abc-mobile-robotics.github.io/commit/eab7cd7)| startup.sh                                   |
